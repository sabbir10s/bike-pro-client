        ...
        <div className='grid lg:grid-cols-2 w-full'>
            <div className='bg-primary w-full h-screen flex justify-center items-center order-2 lg:order-1'>
                <div>
                    ...
                    <p className='text-center text-base-200 mx-3 md:mx-5 mt-2'>Bike Pro is one of the largest wholesale bicycle suppliers. We supply different types of brands of bicycles.  On this website, we manage our all product inventory.</p>
            ...
            <div className='h-screen flex justify-center items-center order-1 lg:order-2'>
                <div className='max-w-[450px] px-2'>
                    <form onSubmit={creatUser}>
                        ...
                        <input className='rounded-md w-full border border-primary mt-8 p-2 text-1xl' type="text" name='name' placeholder='Your Name' required />
