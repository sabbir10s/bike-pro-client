        ...
        <div className='flex justify-center h-screen bg-secondary'>
            <div className='max-w-[400px] p-5 my-12 bg-white rounded-lg'>
                <form onSubmit={handelSignInWithEmail}>
                    <span className='text-primary  text-3xl'>Sign In</span>
                    ...
                    <input className=' rounded-md w-full border border-primary mt-4 p-2 text-1xl' type="password" name='password' defaultValue='123456' placeholder='Your Password' />
                    {
                    ...
                    <span className='text-black mt-4 block'>Forget password ? <button onClick={resetPassword} className='text-primary font-bold'>Forget</button></span>
                    <span className='text-black mt-4 block'>Dont't have an account <Link to='/signup' className='text-primary font-bold'>Sign Up</Link> </span>
                </form>
