        ...
        <div className='flex justify-center h-screen items-center bg-secondary'>
            <div className='max-w-[400px] p-5 my-8 bg-white rounded-lg'>
                <form onSubmit={creatUser}>
                    <span className='text-primary  text-3xl'>Sign Up</span>
                    ...
                    <span className='text-black mt-4 block'>Dont't have an account <Link to='/signIn' className='text-primary font-bold'>Sign In</Link> </span>
                </form>
                <SocialSignIn />
            </div>
        </div>
