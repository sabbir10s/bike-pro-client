            ...
            <div className="w-full h-[75vh] flex items-center justify-center bg-slate-300">
                ...
                <div className='w-[100%] md:w-[40%]'>
                    ...
                    <div className='flex justify-center'>
                        <button onClick={() => navigate('/menageProduct')} className='rounded p-2 leading-none text-white text-xl hover:bg-secondary hover:text-white bg-primary mt-4 flex gap-2 '><span>Manage Product</span><AiOutlineArrowRight /></button>
                    </div>
                </div>
