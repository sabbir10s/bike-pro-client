        ...
        <div className='banner mb-14'>
            <div className=" w-full h-[74vh] flex items-center ">
                <div className='text-white w-[50%] mx-10 z-10'>
                    ...
                    <button onClick={() => navigate('/menageinventory')} className='p-3 leading-none text-white text-xl hover:bg-[#f32105] hover:text-white bg-[#ff634e] mt-4 flex gap-2 '><span>Manage Inventory</span><AiOutlineArrowRight /></button>
                </div>
            </div>
        </div>
    );
