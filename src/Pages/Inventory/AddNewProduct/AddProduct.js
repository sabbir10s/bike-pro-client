            ...
            <div className='mx-2 w-full md:w-[450px] border-2 border-primary p-5 rounded-lg shadow-xl'>
                ...
                <form onSubmit={handleUpload}>
                    <div className="relative z-0 w-full mb-6 group">
                        <input type="email" value={user.email} name="email" id='product_name' className="block py-2 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none    focus:outline-none focus:ring-0 focus:border-[#ff634e] peer" placeholder='  ' readOnly required />
                    ...
                    <div className="relative z-0 w-full mb-6 group">
                        <input type="text" name="picture" id="picture" className="block py-2 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none    focus:outline-none focus:ring-0 focus:border-[#ff634e] peer" placeholder=' ' autoComplete='off' required />
