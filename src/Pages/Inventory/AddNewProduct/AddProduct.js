...
const AddProduct = () => {
    ...
    return (
        <div>
            <h1 className='text-xl font-medium text-left pb-3'>Add New Product</h1>
            <div className='bg-base-100 rounded-lg h-[85vh]'>
                <div className='p-10 lg:w-1/2'>
                    ...
                    <form onSubmit={handleUpload}>
                        ...
                        <div className="relative z-0 w-full mb-6 group">
                            <textarea rows="2" type="text" name="description" id="description" className="block py-2 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none    focus:outline-none focus:ring-0 focus:border-[#ff634e] peer" placeholder=' ' required />
