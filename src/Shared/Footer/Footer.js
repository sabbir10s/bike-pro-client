...
const Footer = () => {
    return (
        ...
        <footer className="footer-distributed  bg-[#2a2a2a] w-full  py-20 ">

            <div className='container mx-auto'>
                <div className="footer-left w-[30%] inline-block">
                    <img src={logo} className="w-[120px]" alt="" />

                    <p className="text-white flex flex-col-reverse">
                ...
                <div className="footer-center w-[35%] text-white">
                    <div>
                ...
                <div className="footer-right w-[30%] text-gray-300">
